$baseDir = "d:\antigravity website\purseheritage"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "    PURSEHERITAGE - AUDIT REPORT         " -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
...
# 5. Check Strict Exclusions (Medicine, Alcohol, Finance, Property)
...
$forbiddenPatterns = @(
    ...
    '\bmedicine\b', '\bpharmacy\b', '\bpill(s)?\b', '\bpharmaceutical\b'
)
...
if ($indexContent -match "blog-purse-card" -or $indexContent -match "blog-purse-grid") {
...
Write-Host "`nPurseHeritage Audit Completed Successfully." -ForegroundColor Cyan
